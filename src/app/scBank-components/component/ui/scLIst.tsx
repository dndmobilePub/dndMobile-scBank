...
// List 공통 props
type ScListBaseProps<TElement = HTMLElement> = React.HTMLAttributes<TElement> &
  DynamicSpacingProps &
  DynamicBorderProps &
  DynamicRadiusProps &
  DynamicSizeProps & {
...
export const ScListItem = (rawProps: ScListItemProps) => {
  ...
  if (listType === "num" && index != null) {
    ...
    marker = (
      <ScBox
        mt={9}
        className={cn("w-[3px] h-[3px] rounded-[3px]")}
        style={{
          backgroundColor: `var(${dotColor})` || "var(--color-sc-neutral-400)",
        }}
      />
    );
  }
...
export const ScItemlist = (rawProps: ScItemlistTitleProps) => {
  ...
  return (
    <ScHFlex as="li" className={cn(className, type === "detail" && "mx-5")}>
      <ScText
        as="a"
        g={leftIcon === true ? 16 : 8}
        {...rest}
        className={cn(
      ...
      >
        ...
        <ScVFlex g={4}>
          <ScText
            ...
            className={cn(
              "leading-6",
              type === "detail" ? "sc-text-basic-04" : "sc-text-basic-02"
            )}
          >
            {title}
          </ScText>
        ...
        {type === "detail" ? (
          ...
          <ScText>
            <Icon
              name="ArronRight"
              size="lg"
              className={cn(leftIcon ? "text-[#1F8845]" : '"sc-text-basic-02"')}
            />
          </ScText>
        )}
      </ScText>
    ...
    <ScHFlex as="li" className={cn(className)}>
      ...
      >
        <ScBox
          ...
          h={24}
          m={4}
          className="bg-(--color-sc-green-100) relative rounded-4xl"
        >
          <ScBox
            w={20}
            h={20}
            m={2}
            className="bg-white absolute rounded-4xl flex justify-center item-center"
          >
        ...
        <ScVFlex g={4} mt={4}>
          <ScText
            fontStyle="lg-m"
            className={cn("leading-6 sc-text-primary-02")}
          >
            {label}
          </ScText>
