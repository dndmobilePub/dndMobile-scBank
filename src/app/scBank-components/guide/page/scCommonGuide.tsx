        ...
        <ScVFlex g={14} className="bg-white rounded-[10px]" p={20}>
          <ScBox className="grid grid-cols-2 gap-4">
            <ScVFlex g={20}>
              ...
              <ScVFlex g={10}>
                <ScBtnGroup>
                  <ScButton type="button" onClick={() => setOpen(!open)}>
                    바텀시트
                  </ScButton>
                </ScBtnGroup>
                <ScBottomSheet
...
/>`}
            ...
            <ScVFlex g={20}>
              ...
              <ScVFlex g={10} className="h1">
                <ScBtnGroup>
                  <ScButton type="button" onClick={() => setOpen1(!open1)}>
                    바텀시트
                  </ScButton>
                </ScBtnGroup>
                <ScBottomSheet
                  ...
                  footer={
                    <ScFixedBtnGroup>
                      <ScButton type="button" variant="secondary" className="h-12" onClick={() => setOpen1(!open1)}>
                        취소
                      </ScButton>
                      <ScButton type="button" className="h-12" onClick={() => setOpen1(!open1)}>
                        확인
                      </ScButton>
                    </ScFixedBtnGroup>
                  }
