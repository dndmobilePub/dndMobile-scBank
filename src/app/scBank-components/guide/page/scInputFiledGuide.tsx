...
import { ScBox, ScVFlex, ScPhoneField, ScSearchField, ScTextField } from "@scBank/index";
...
<ScTextField labelName="test" placeholder='placeholder' infoMsg="안내메시지" errMsgCheck errMsg='에러메시지'/>`}
            ...
            <ScVFlex g={20}>
              ...
              <pre className={preStyle}>{`<ScSearchField labelName="search" placeholder='검색어 입력하세요'/>`}</pre>
            </ScVFlex>
          </ScBox>
        </ScVFlex>
      </ScVFlex>
