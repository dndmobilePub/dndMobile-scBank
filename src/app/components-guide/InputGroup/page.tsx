...
import { ComponentGuideInputGroupPage } from './pageGuideInputGroup';
...
export default function ComponentInputGroupPage() {
  const folderName = path.basename(__dirname);

  return (
    <GuidePageLayout name={folderName}>
      <ComponentGuideInputGroupPage preStyle={preStyle}/>
    </GuidePageLayout>
  );
}
